...
<!-- Filters and Sort -->
<div class="container mx-auto px-4 pt-20 mb-6">
                ...
                <div class="bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden group relative flex flex-col h-full">
                    <a href="product.php?id=<?php echo $product['id']; ?>" class="block flex-1">
                        ...
                        <div class="p-4 flex-1 flex flex-col">
                            <div class="mb-2">
                                <span class="text-xs font-medium text-gray-500 hover:text-gray-800">
                                    <?php echo htmlspecialchars($product['category_name'] ?? 'Uncategorized'); ?>
                                </span>
                            </div>
                            <h3 class="text-sm font-semibold text-gray-500 group-hover:text-gray-900 transition-colors">
