    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex space-x-6">
                <a href="index.php?category=1" class="text-gray-800 hover:text-gray-600 font-medium">WOMEN</a>
                <a href="index.php?category=2" class="text-gray-800 hover:text-gray-600 font-medium">MEN</a>
                <a href="index.php?category=3" class="text-gray-800 hover:text-gray-600 font-medium">CHILDREN</a>
                <a href="index.php?category=4" class="text-gray-800 hover:text-gray-600 font-medium">POPULAR</a>
            </div>
